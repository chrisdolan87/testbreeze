<x-app-layout>
    <section class="w-full min-h-min h-full mx-auto p-8 flex flex-col md:items-start sm:items-center bg-white gap-8">
        <div class="max-w-2xl w-full mx-auto p-8 flex flex-col">
            <div
                class="max-w-2xl w-full min-h-min h-full mx-auto px-16 py-8 flex flex-col rounded-3xl bg-slate-100 border border-gray-300 shadow-md shadow-slate-700">
        ...
        <div class="max-w-2xl w-full mx-auto px-8">
            <x-back-button />
        </div>
    </section>
</x-app-layout>
