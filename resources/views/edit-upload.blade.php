<x-app-layout>
    <section
        class="min-h-min h-full m-8 p-8 flex flex-col rounded-3xl bg-gray-100 border border-gray-300 shadow-lg shadow-gray-300 gap-8">
        <form class="flex flex-col min-h-min h-fit"
            method="POST" action="/upload/update/{{ $book->id }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mt-4">
                ...
                <x-text-input id="author" class="block mt-1 w-full" type="text" name="author" value="{{ $book->author->name }}"
                    required />
            ...
            <div class="mt-4">
                ...
                <x-text-input id="genre" class="block mt-1 w-full" type="text" name="genre" value="{{ $book->genre->name }}"
                    required />
            ...
            <div class="mt-4">
                ...
                <x-text-input id="price" class="block mt-1 w-full" type="number" name="price" value="{{ $book->price }}"
